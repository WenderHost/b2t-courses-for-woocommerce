...
<div class="class-calendar">
  <div class="row header hide-sm">
    ...
    <div class="col-md-2 time">'.htmlspecialchars((string)((isset($in['labels']) && is_array($in['labels']) && isset($in['labels']['time'])) ? $in['labels']['time'] : null), ENT_QUOTES, 'UTF-8').'/'.htmlspecialchars((string)((isset($in['labels']) && is_array($in['labels']) && isset($in['labels']['duration'])) ? $in['labels']['duration'] : null), ENT_QUOTES, 'UTF-8').'</div>
...
'.LR::sec($cx, (($inary && isset($in['classes'])) ? $in['classes'] : null), null, $in, true, function($cx, $in) {$inary=is_array($in);return '  <div class="row '.htmlspecialchars((string)(($inary && isset($in['css_classes'])) ? $in['css_classes'] : null), ENT_QUOTES, 'UTF-8').' hide-sm desktop-row location-'.htmlspecialchars((string)((isset($in['location']) && is_array($in['location']) && isset($in['location']['slug'])) ? $in['location']['slug'] : null), ENT_QUOTES, 'UTF-8').'">
    ...
    <div class="col-md-2 time">'.htmlspecialchars((string)(($inary && isset($in['times'])) ? $in['times'] : null), ENT_QUOTES, 'UTF-8').''.((LR::ifvar($cx, (($inary && isset($in['duration'])) ? $in['duration'] : null), false)) ? '<br>'.(($inary && isset($in['duration'])) ? $in['duration'] : null).'' : '').'</div>
